...
@foreach ($races as $race)
    <tr>
        ...
        <td class="text-center">
            <a class="btn btn-info" href="{{ route('races.show',$race->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
          ...
          @can('race-edit')
            ...
            <a class="btn btn-primary" href="{{ route('races.edit',$race->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
